...
"![Imágen con diferentes Sistemas Operativos del mercado](../imagenes/2.2-Tipos_de_SO-VariedadSistemasOperativos.png)"
...
### Ejemplos:
- **Android:** Basado en el núcleo de Linux, ampliamente usado, personalizable y compatible con muchas marcas.
...
### Usos más comunes:
- Smartphones, tablets, Smart TV's, dispositivos wereables (relojes, pulseras, etc.) y otros dispositivos IoT.
...
<<<<<<< HEAD
=======
>>>>>>> 7761973a4cf5298b7114d4ffc0d83fa9576153d0
...
- **Década de 1950:**  
  ...
  ![Computadora mainframe de los 50s](../imagenes/2.2-Tipos_de_SO-Computadora_mainframe_anos50.jpg)
...
- **Década de 1960:**  
  ...
  ![Unix en 1969](../imagenes/2.2-Tipos_de_SO-Unix_en_1969.png)
...
- **Década de 1980:**  
  ...
  *Unix* se consolidó en entornos empresariales.  
  ![MS-DOS](../imagenes/2.2-Tipos_de_SO-MSDOS.jpg)
...
- **Década de 1990:**  
  *Windows 95* combinó *MS-DOS* con una interfaz gráfica avanzada, marcando un estándar en el mercado de PC.  
  ...
  ![Windows 95](../imagenes/2.2-Tipos_de_SO-Windows95.png)
...
- **Década de 2000 en adelante:**  
  ...
  ![Android e iOS](../imagenes/2.2-Tipos_de_SO-AndroidIOS.jpg)
...
![Computación en la nube](../imagenes/2.2-Tipos_de_SO-cloudComputing.png)
